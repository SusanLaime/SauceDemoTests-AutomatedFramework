Feature: Home Page tests
  ...
  Background: User login into sauce demo
    ...
    Scenario: Verify that Reset App State restores the product button
      When The home pages should be displayed
      And I add the product "Sauce Labs Backpack" to the cart
      Then the product "Sauce Labs Backpack" button should display "Remove"
      When I reset the app state
      Then the product "Sauce Labs Backpack" button should display "Add to cart"
